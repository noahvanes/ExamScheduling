...
availability(Room,Day,9,17) :- room(Room,_), (between(3,7,Day);between(10,14,Day);between(17,21,Day)).
...
sc_not_in_period(l1,e1,21,0,24,10).
sc_not_in_period(l12,e18,21,0,24,10).
sc_not_in_period(l3,e3,21,0,24,5).
sc_not_in_period(l13,e19,21,0,24,5).
sc_not_in_period(l1,e1,20,0,24,5).
sc_not_in_period(l12,e18,20,0,24,5).
%Lecturer time preferences/unavailabilities
sc_no_exam_in_period(l1,10,0,24,5). %Janis Bolls prefers to have no exam day 10.
sc_no_exam_in_period(l1,18,0,12,2). %Janis Bolls prefers to have no exam before noon, day 18.
sc_no_exam_in_period(l2,7,0,24,5). %Ana Falacco prefers to have no exam day 7.
sc_no_exam_in_period(l2,11,0,12,5). %Ana Falacco prefers to have no exam before noon, day 11.
sc_no_exam_in_period(l2,17,12,24,2). %Ana Falacco prefers to have no exam in the afternoon, day 17.
sc_no_exam_in_period(l2,21,0,12,5). %Ana Falacco prefers to have no exam before noon, day 21.
sc_no_exam_in_period(l4,5,12,24,2). %Glenn Janson prefers to have no exam in the afternoon, day 5.
sc_no_exam_in_period(l4,12,12,24,2). %Glenn Janson prefers to have no exam in the afternoon, day 12.
sc_no_exam_in_period(l4,19,12,24,2). %Glenn Janson prefers to have no exam in the afternoon, day 19.
sc_no_exam_in_period(l4,6,12,24,2). %Glenn Janson prefers to have no exam in the afternoon, day 6.
sc_no_exam_in_period(l4,13,12,24,2). %Glenn Janson prefers to have no exam in the afternoon, day 13.
sc_no_exam_in_period(l4,20,12,24,2). %Glenn Janson prefers to have no exam in the afternoon, day 20.
sc_no_exam_in_period(l6,6,12,24,5). %Hong Fedde prefers to have no exam in the afternoon, day 6.
sc_no_exam_in_period(l6,12,0,12,5). %Hong Fedde prefers to have no exam before noon, day 12.
sc_no_exam_in_period(l6,14,0,24,5). %Hong Fedde prefers to have no exam day 14.
sc_no_exam_in_period(l7,3,0,24,2). %Nicky Waltos prefers to have no exam day 3.
sc_no_exam_in_period(l7,4,0,24,2). %Nicky Waltos prefers to have no exam day 4.
sc_no_exam_in_period(l7,5,0,24,2). %Nicky Waltos prefers to have no exam day 5.
sc_no_exam_in_period(l7,6,0,24,2). %Nicky Waltos prefers to have no exam day 6.
sc_no_exam_in_period(l7,7,0,24,2). %Nicky Waltos prefers to have no exam day 7.
sc_no_exam_in_period(l9,17,0,24,2). %Shae Mostowy prefers to have no exam day 17.
sc_no_exam_in_period(l9,18,0,24,2). %Shae Mostowy prefers to have no exam day 18.
sc_no_exam_in_period(l9,19,0,24,2). %Shae Mostowy prefers to have no exam day 19.
sc_no_exam_in_period(l9,20,0,24,2). %Shae Mostowy prefers to have no exam day 20.
sc_no_exam_in_period(l9,21,0,24,2). %Shae Mostowy prefers to have no exam day 21.
sc_no_exam_in_period(l11,10,0,24,5). %Delmer Zwilling prefers to have no exam day 10.
sc_no_exam_in_period(l11,11,0,24,5). %Delmer Zwilling prefers to have no exam day 11.
sc_no_exam_in_period(l11,12,0,24,5). %Delmer Zwilling prefers to have no exam day 12.
sc_no_exam_in_period(l11,13,0,24,5). %Delmer Zwilling prefers to have no exam day 13.
sc_no_exam_in_period(l11,14,0,24,5). %Delmer Zwilling prefers to have no exam day 14.
sc_no_exam_in_period(l12,6,0,12,5). %Shalon Stains prefers to have no exam before noon, day 6.
sc_no_exam_in_period(l12,13,0,12,5). %Shalon Stains prefers to have no exam before noon, day 13.
sc_no_exam_in_period(l12,20,0,12,5). %Shalon Stains prefers to have no exam before noon, day 20.
sc_no_exam_in_period(l12,7,0,12,5). %Shalon Stains prefers to have no exam before noon, day 7.
sc_no_exam_in_period(l12,14,0,12,5). %Shalon Stains prefers to have no exam before noon, day 14.
sc_no_exam_in_period(l12,21,0,12,5). %Shalon Stains prefers to have no exam before noon, day 21.
sc_no_exam_in_period(l13,6,12,24,5). %Colleen Raike prefers to have no exam in the afternoon, day 6.
sc_no_exam_in_period(l13,18,0,12,2). %Colleen Raike prefers to have no exam before noon, day 18.
sc_no_exam_in_period(l13,19,0,12,5). %Colleen Raike prefers to have no exam before noon, day 19.
sc_no_exam_in_period(l13,21,12,24,2). %Colleen Raike prefers to have no exam in the afternoon, day 21.
sc_no_exam_in_period(l15,10,12,24,2). %Oswaldo Bardo prefers to have no exam in the afternoon, day 10.
sc_no_exam_in_period(l16,5,0,12,5). %Jama Nguyn prefers to have no exam before noon, day 5.
sc_no_exam_in_period(l16,12,0,12,5). %Jama Nguyn prefers to have no exam before noon, day 12.
sc_no_exam_in_period(l16,19,0,12,5). %Jama Nguyn prefers to have no exam before noon, day 19.
sc_no_exam_in_period(l17,5,0,12,5). %Charleen Mellema prefers to have no exam before noon, day 5.
sc_no_exam_in_period(l18,Day,15,24,3) :- (between(3,7,Day);between(10,14,Day);between(17,21,Day)). %Adelina Gord prefers to have no exam after 15h.
sc_no_exam_in_period(l19,6,0,12,5). %Madeleine Ryba prefers to have no exam before noon, day 6.
sc_no_exam_in_period(l19,13,0,12,5). %Madeleine Ryba prefers to have no exam before noon, day 13.
sc_no_exam_in_period(l19,20,0,12,5). %Madeleine Ryba prefers to have no exam before noon, day 20.
